...
\item Developed a web application to visualize aggregated data from kdb+ database and present it with Ext JS and Highcharts library. It helped identifying potential high value clients for equity derivative based products.
\item Helped refactor a code base to accomodate bitemporal data type.
\end{list}
}
