...
\item Implemented caching layer in identity, assignment components of Keystone.
\item Implemented role base access control in MagnetoDB.
...
\noindent
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
\textbf{Morgan Stanely Advantage Services} & Mumbai \\
...
\item Developed an application to crunch data from the in-house in-memory database and present it with extjs. 
\end{list}
}
...
\noindent
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
\textbf{Google Summer Of Code} & WFH \\
...
\emph{Student Developer} & \emph{May 2012 to July 2012} \\
\end{tabular*}
{\small
\noindent
\begin{list}{$\bullet$}{
...
\noindent
\textbf{Programming Languages: } Python, C++, Go-lang.
\\
